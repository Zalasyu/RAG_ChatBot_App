...
class VectorStore:
    ...
    def __init__(self, base_url: str, model_name: str = "BAAI/bge-base-en-v1.5", collection_name: str = 'full_website'):
        ...
        self.vector_store = Chroma(collection_name=collection_name, embedding_function=self.embeddings, persist_directory='./chroma_db')
        fs = LocalFileStore("./store_location")

        # This text splitter is used to create the parent documents
        self.parent_splitter = RecursiveCharacterTextSplitter.from_language(chunk_size=2000, chunk_overlap=200, add_start_index=True, language=Language.HTML)

        # This text splitter is ued to create the child documents
        self.child_splitter =RecursiveCharacterTextSplitter.from_language(chunk_size=400, add_start_index=True, language=Language.HTML)
    ...
    def load_retriever(self) -> ParentDocumentRetriever:
        ...
        self.vector_store = Chroma(collection_name="full_website", embedding_function=self.embeddings, persist_directory="./chroma_db")
    ...
    def search(self, query: str, k: int = 4) -> List[Dict[str, Any]]:
        ...
        return [doc.page_content for doc in retrieved_docs[:k]]
...
if __name__ == "__main__":
    ...
    results = vector_store.search("Which page has information about repairing a Samsung dryer?")
